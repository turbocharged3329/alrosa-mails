<template>
  <div class="mail-name mail-block" :style="{backgroundColor: backgroundColor}">
    ...
    <div class="mail-content">
      ...
      <input v-model="content" class="content__input" v-if="showEditor" placeholder="Введите название письма"/>
